    ...
    return (
        <div className="container py-10">
            ...
            <div className="py-8 px-8 bg-black rounded-3xl flex justify-between my-10">
                <img src={Radio} width={320} className="grayscale hover:grayscale-0" alt="img"/>
                <div className="w-[68%]">
                    <button className="my-4 bg-[#191919] text-white bg-blue-900 px-3 rounded-lg ">Gear</button>
            ...
            <div className="py-8 px-8 bg-black rounded-3xl flex justify-between my-10 ">
                <img src={Radio} width={320} className="grayscale hover:grayscale-0" alt="img"/>
                <div className="w-[68%]">
                    <button className="my-4 px-3 bg-[#191919] text-white bg-blue-900  rounded-lg ">Tips & Tricks</button>
            ...
            <div className="py-8 px-8 bg-black rounded-3xl flex justify-between my-10">
                <img src={Radio} className="grayscale hover:grayscale-0" width={320} alt="img"/>
                <div className="w-[68%]">
                    <button className="my-4 text-white bg-[#191919] px-3 rounded-lg ">Gear</button>
